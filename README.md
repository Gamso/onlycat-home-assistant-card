...
name: "Chatière" # Optional — card title (default: "Chatière")
...
Copy (or symlink) `dist/` into `<config>/www/onlycat_card/` then hard-refresh
the browser after each rebuild (`Ctrl + Shift + R`).
